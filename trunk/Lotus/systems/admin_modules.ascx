...
<asp:GridView ID="gridModules" GridLines=None AlternatingRowStyle-BackColor="#f6f7f8" HeaderStyle-BackColor="#d6d7d8" CellPadding=7 runat="server" AllowPaging="False" PageSize="30" HeaderStyle-HorizontalAlign=Left AutoGenerateColumns="False" DataSourceID="SqlDataSource1" AllowSorting="True" DataKeyNames="module_file" OnPreRender="gridModules_PreRender">
    <Columns>
