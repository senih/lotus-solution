...
<script runat="server">
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs)
        ...
        SqlDataSource3.ConnectionString = sConn
        ...
        Else
            If Roles.IsUserInRole(GetUser.UserName.ToString(), "Administrators") Then
                ...
                panelScript.Controls.Add(New LiteralControl("<script>" & _
                ...
                SqlDataSource3.SelectCommand = "SELECT page_modules.*, templates.template_name FROM templates RIGHT OUTER JOIN " & _
                ...
                SqlDataSource3.DeleteCommand = "DELETE FROM page_modules WHERE page_module_id = @page_module_id"
    ...
    Function HideCustomEntries(ByVal bUseCustom As Boolean) As String
        If bUseCustom Then
            Return "<span>"
        Else
    ...
    Protected Sub btnEmbed_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnEmbed.Click
        ...
        oCmd.Parameters.Add("@module_data", SqlDbType.NVarChar).Value = hidModuleData.Value
        oConn.Open()
        oCmd.Connection = oConn
        oCmd.ExecuteNonQuery()
        oConn.Close()
        ...
        'SqlDataSource3.OldValuesParameterFormatString = "original_{0}"
    End Sub
    ...
    Protected Sub gridCustomListing_SelectedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs)
        ...
        hidModuleData.Value = gridCustomListing.SelectedDataKey().Value
        ...
        oCmd.CommandType = CommandType.Text
        oCmd.Parameters.Add("@custom_listing_id", SqlDbType.Int).Value = hidModuleData.Value
    ...
    Protected Sub grvModules_RowDeleting(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewDeleteEventArgs)
        panelEmbed.Visible = True
        panelCustomListing.Visible = False
        panelEntries.Visible = False
    ...
    Protected Sub grvModules_Sorting(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewSortEventArgs)
        panelEmbed.Visible = True
        panelCustomListing.Visible = False
        panelEntries.Visible = False
    End Sub
    ...
    Sub ListPageModules()       
        SqlDataSource3.SelectCommand = "SELECT page_modules.*, templates.template_name FROM templates RIGHT OUTER JOIN " & _
            ...
            " where page_modules.module_file=@module_file AND module_data=@module_data"
        SqlDataSource3.DeleteCommand = "DELETE FROM page_modules WHERE page_module_id = @page_module_id"
        SqlDataSource3.SelectParameters(0).DefaultValue = "custom_listing.ascx"
        SqlDataSource3.SelectParameters(1).DefaultValue = hidModuleData.Value
        grvModules.DataBind()
    End Sub


    'CUSTOM ENTRIES
    Protected Sub ListEntries()
        SqlDataSource2.DeleteCommand = "DELETE FROM [custom_listing_items] WHERE [custom_listing_item_id] = @custom_listing_item_id"
        SqlDataSource2.SelectCommand = "SELECT * FROM custom_listing_items WHERE custom_listing_id=@custom_listing_id"
        SqlDataSource2.SelectParameters("custom_listing_id").DefaultValue = hidCustListId.Value
        
        gridEntries.DataBind()
    End Sub
    
    Protected Sub gridCustomListing_RowCreated(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewRowEventArgs)
        If e.Row.RowType = DataControlRowType.DataRow Then
            Dim addButton As LinkButton = CType(e.Row.Cells(1).Controls(1), LinkButton)
            addButton.Attributes("index") = e.Row.RowIndex.ToString() 'Utk Custom Entries
        End If
    End Sub
    
    Protected Sub lnkCustomEntries_Click(ByVal sender As Object, ByVal e As System.EventArgs)
        ...
        hidCustListId.Value = gridCustomListing.DataKeys(index).Value
        ...
        oCmd.CommandText = "SELECT * FROM custom_listings WHERE custom_listing_id=@custom_listing_id"
        oCmd.CommandType = CommandType.Text
        oCmd.Parameters.Add("@custom_listing_id", SqlDbType.Int).Value = hidCustListId.Value
        oDataReader = oCmd.ExecuteReader
        If oDataReader.Read Then
    ...
    Protected Sub gridEntries_RowDeleting(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewDeleteEventArgs)
        panelEntries.Visible = True
        panelCustomListing.Visible = False
        panelEmbed.Visible = False
...
<asp:GridView ID="gridCustomListing" GridLines=None AlternatingRowStyle-BackColor="#f6f7f8" HeaderStyle-BackColor="#d6d7d8" CellPadding=7 runat="server" AllowPaging="True" PageSize="20" HeaderStyle-HorizontalAlign=Left AutoGenerateColumns="False" DataSourceID="SqlDataSource1" AllowSorting="True" DataKeyNames="custom_listing_id" OnRowDeleting="gridCustomListing_RowDeleting" OnPageIndexChanging="gridCustomListing_PageIndexChanging" OnPreRender="gridCustomListing_PreRender" OnSelectedIndexChanged="gridCustomListing_SelectedIndexChanged" OnRowCreated="gridCustomListing_RowCreated">
    <Columns>
        ...
        <ItemTemplate>
            <%#HideCustomEntries(Eval("use_custom_entries"))%>
            <asp:LinkButton ID="lnkCustomEntries" meta:resourcekey="lnkCustomEntries" runat="server" OnClick="lnkCustomEntries_Click">Custom Entries</asp:LinkButton>
            </span><%#ShowType(Eval("use_custom_entries"), Eval("parent_id"), Eval("custom_listing_id"))%>
        </ItemTemplate>
        </asp:TemplateField>  
...
<td>
    ...
    <td style="white-space:nowrap">
        ...
        <asp:TextBox ID="txtPageId" Width="30" runat="server"></asp:TextBox>
        <asp:Label ID="lblSpecifyPageIdHere" meta:resourcekey="lblSpecifyPageIdHere" runat="server" Font-Italic="true" Text="(Specify Page ID here)"></asp:Label>
        <asp:CustomValidator runat="server" id="cv1" ClientValidationFunction="clientValidateType" ErrorMessage="*" ValidationGroup="Create" SetFocusOnError="true"></asp:CustomValidator>
    </td>
    </tr>
    <tr>
    <td>
...
<br /><asp:Button ID="btnCreate" meta:resourcekey="btnCreate" runat="server" Text=" Create " ValidationGroup="Create" OnClick="btnCreate_Click" />
</td>
</tr>
</table>
</div>
...
<asp:HiddenField ID="hidCustListId" runat="server" />
...
<asp:GridView ID="gridEntries" GridLines="None" AlternatingRowStyle-BackColor="#f6f7f8" HeaderStyle-BackColor="#d6d7d8" CellPadding=7 runat="server" AllowPaging="True" PageSize="20" HeaderStyle-HorizontalAlign=Left AutoGenerateColumns="False" DataSourceID="SqlDataSource2" AllowSorting="True" DataKeyNames="custom_listing_item_id" OnPreRender="gridEntries_PreRender" OnPageIndexChanging="gridEntries_PageIndexChanging" OnRowDeleting="gridEntries_RowDeleting">
<Columns>
...
<asp:HiddenField ID="hidModuleData" runat="server" />
...
<td valign="top">
    <asp:GridView ID="grvModules" AlternatingRowStyle-BackColor="#f6f7f8" HeaderStyle-BackColor="#d6d7d8" CellPadding=7 HeaderStyle-HorizontalAlign=Left runat="server"
       GridLines=None AutoGenerateColumns="False" AllowPaging="False" AllowSorting="True" 
       DataSourceID="SqlDataSource3" DataKeyNames="page_module_id"  OnPreRender="grvModules_PreRender" OnRowDeleting="grvModules_RowDeleting" OnSorting="grvModules_Sorting">
           <Columns>       
