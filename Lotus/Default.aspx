...
<asp:Content ID="contentPlaceholderBody" ContentPlaceHolderID="placeholderBody" runat="server">
    ...
    <!-- PAGE INFO -->
    <asp:Panel ID="panelPageInfo" runat="server">

        <table summary="" cellpadding="0" cellspacing="0" style="width:470px;margin-bottom:5px;margin-top:15px">
        <tr>
        ...
        <td colspan="3" valign="top" style="border:#9FAEB0 1px solid;border-top:none;padding:1px;padding-top:0px;background:#E6E7E8;">
            ...
            <div runat=server id="pannelChannelInfo" style="font-size:x-small;font-family:verdana;padding-left:7px;padding-top:3px;border:#9BAFCA 1px solid;border-top:none;border-bottom:none;">
                ...
                <td valign="top">
                <div style="width:90px;font-size:x-small;font-family:verdana;">
                <asp:Label ID="lblChannelLabel" meta:resourcekey="lblChannelLabel" runat="server" Text="Channel"></asp:Label>
                </div>
                </td>
                <td valign="top" style="font-size:x-small;font-family:verdana;">:</td>
                <td style="width:100%;padding-left:4px;font-size:x-small;font-family:verdana;">
        ...
        function _showMoreInfo(oEl1,oEl2)
            ...
            divMoreInfo.style.top='5px';
            divMoreInfo.style.left='5px';
            }
        function _hideMoreInfo(oEl1,oEl2)
            {
            oEl1.style.display='block';
...
<%--    <asp:UpdateProgress ID="UpdateProgress1" AssociatedUpdatePanelID="UpdatePanel1"  runat="server">
        <ProgressTemplate>
            ...
            <div class="icProgBg" style="padding-top:150px;text-align:center;z-index:2100">  
                <img src="systems/images/ajax_progress.gif" alt="" style="border:#ffffff 1px solid" />      
            </div>
        </ProgressTemplate>
    </asp:UpdateProgress>
...
<%--    </ContentTemplate>    
    ...
    <asp:TextBox id="ic_dummy" text="dummy" runat="server"></asp:TextBox>
    <asp:RequiredFieldValidator ControlToValidate="ic_dummy" runat="server" ErrorMessage="*"></asp:RequiredFieldValidator>
    </div>
    
    <table id="panelQuickAdd" summary="" runat="server" visible="false" cellpadding="2" cellspacing="0" style="background:white;border:#E0E0E0 1px solid;margin-top:15px;margin-bottom:15px;">
    <tr>
    ...
    <!-- MANAGEMENT -->    
    <asp:Panel ID="panelManagement" runat="server" visible="False">
